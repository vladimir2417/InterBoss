...
namespace SlanjeFakture
{
    public partial class MainClass : Window
    {
        ...
        public void puniDataTable(Artikal artikal, int kolicina, int rabat)
        {
            ...
            double? poreskaOsnovica = kolicina * (artikal.OsnovicaPoJM - (artikal.OsnovicaPoJM * rabat / 100));

            double? prodajnaCena = poreskaOsnovica * 1.25;
            ...
            red["PDV stopa"] = "20";
            red["PDV iznos"] = prodajnaCena * 0.2 * kolicina;
                ...
                if (tabelaProizvoda.Rows.Count > 0)
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            faktura.IznosRabata = Convert.ToDouble(ukupnoRabat);
                            faktura.IznosBezRabata = iznosBezRabata;
                            faktura.Ukupno = Convert.ToDouble(ukupnoSve);
